...
bg = PhotoImage(file='1-Fish-icon.png')
# bg = PhotoImage(file= r'C:\Users\Uncle Engineer\Desktop\Basic Python\car.png')

BG = Label(GUI, image=bg)
BG.pack()

L = Label(GUI,text='กรุณากรอกจำนวนราคาปลา (กิโลกรัม)',font=(None,20))
L.pack()
...
v_fish = StringVar() # เป็นตัวแปรที่ใช้เก็บข้อความเมื่อพิมพ์เสร็จแล้ว
E2 = ttk.Entry(GUI, textvariable=v_fish, font=(None,20))
E2.pack()
